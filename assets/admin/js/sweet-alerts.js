(function ($) {
 ...
 Swal.fire({
          // title: '<strong>Insert tag</strong>',
          
          html: ' <input type="text" class="form-control" id="insertPodKatVrednost" placeholder="Tag name"><input type="submit" id="insertPodKat" class="btn btn-primary" value="Insert"/>',
